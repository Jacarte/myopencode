...
Persistent memory layer for AI agents via local Mem0 REST API at `http://192.168.0.160:1800`.

## API Operations

### Store Memory
```bash
curl -X POST http://192.168.0.160:1800/memories \
...
### Search Memories
```bash
curl -X POST http://192.168.0.160:1800/search \
  -H "Content-Type: application/json" \
  -d '{
    "query": "search text",
    "user_id": "user-123",
...
### Get All Memories
```bash
curl "http://192.168.0.160:1800/memories?user_id=user-123&agent_id=opencode"
```

### Get Specific Memory
```bash
curl http://192.168.0.160:1800/memories/{memory_id}
```

### Update Memory
```bash
curl -X PUT http://192.168.0.160:1800/memories/{memory_id} \
  -H "Content-Type: application/json" \
...
### Delete Memory
```bash
curl -X DELETE http://192.168.0.160:1800/memories/{memory_id}
```

### Delete All Memories
```bash
curl -X DELETE "http://192.168.0.160:1800/memories?user_id=user-123"
```

### Get Memory History
```bash
curl http://192.168.0.160:1800/memories/{memory_id}/history
```
